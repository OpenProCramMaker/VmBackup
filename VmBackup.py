...
# Title: VmBackup - a XenServer Backup Script
...
if __name__ == '__main__':
    ...
    for opt in arg_range:
        array = sys.argv[opt].strip().split('=')
        if array[0].lower() == 'preview':
            ...
            print 'ERROR invalid parm: %s' % sys.argv[opt]
            usage()
            sys.exit(1)
